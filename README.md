...
A static GitHub Pages essay on what institutions owe people when expert judgment becomes software:
...
a contestability test, composite case files, an agent-response comparison, a worked distillation example,
public accountability cards, field notes, a final automation checklist, and scroll-triggered effects
that keep text readable during anchor jumps and quick mobile scrolling.
